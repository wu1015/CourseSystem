...
public class ClassStdTableAdapter2 extends BaseAdapter {
    ...
    private List<Major> datas;

    public ClassStdTableAdapter2(Context context, List<Major> datas, boolean[] chk_chk) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.textViewName.setText(datas.get(i).getM_Name().toString());
