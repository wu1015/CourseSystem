...
public class MainActivity extends AppCompatActivity {
    ...
    private ItemClassCenterFragment itemClassCenterFragment;
    private ItemClassTableFragment itemClassTableFragment;
...
*/
        ...
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (id == R.id.itemClassCenter) {
                    fragmentList=newFragments();
                    ViewPageAdapter viewPageAdapter = new ViewPageAdapter(MainActivity.this, fragmentList);
                    viewPager2.setAdapter(viewPageAdapter);
    ...
    private List<Fragment> newFragments() {
        ...
        itemClassCenterFragment = new ItemClassCenterFragment(user);
        itemClassTableFragment = new ItemClassTableFragment(user);
        return Arrays.asList(itemClassCenterFragment, itemMeFragment, itemClassTableFragment);
    }
